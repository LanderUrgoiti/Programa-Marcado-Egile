...
def buscar_y_pegar(valor,archivo,of):
    # Buscar si existe u
...
#BUSCAR LOS DATOS DEL PROGRAMA DEFINIDOS EN LA BASE DE DATOS DE MARCADO
    try:
        ...
        #    ASSY = resultado[7]    
            #REV = resultado[8]
        Fichero = datos.PROGRAMA.loc[datos.PROGRAMA['PARTNUMBER']==KH, 'FICHERO'].values[0]
        MARCADORA = datos.PROGRAMA.loc[datos.PROGRAMA['PARTNUMBER']==KH, 'MARCADORA'].values[0]
        Tipo_Marcado = datos.PROGRAMA.loc[datos.PROGRAMA['PARTNUMBER']==KH, 'TIPO MARCADO'].values[0]
        MFR = datos.PROGRAMA.loc[datos.PROGRAMA['PARTNUMBER']==KH, 'MFR'].values[0] + ' '
        SER = datos.PROGRAMA.loc[datos.PROGRAMA['PARTNUMBER']==KH, 'SER'].values[0] + ' '
        PNR = datos.PROGRAMA.loc[datos.PROGRAMA['PARTNUMBER']==KH, 'PNR'].values[0] + ' '
        ASSY = datos.PROGRAMA.loc[datos.PROGRAMA['PARTNUMBER']==KH, 'ASSY'].values[0]
